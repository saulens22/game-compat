...
prefix="$state_root/nba-live-07/pfx"
ini="$prefix/drive_c/Program Files (x86)/EA SPORTS/NBA LIVE 07/main.ini"
[[ -f $ini ]] || { echo "NBA Live 07 widescreen configuration is missing: $ini" >&2; exit 1; }
