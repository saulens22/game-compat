...
artwork_dir="$case_dir/configs/pokemon-violet-steam-artwork"
source_url='https://img-eshop.cdn.nintendo.net/i/6b9ea8f1503b00da868d145995cfe9b2ee9f58dbc1dd19d4c479a07d5761d952.jpg?w=1000'
source_sha256='60580d46326be273423468e42660e86a616fed11704515bc24d1ac6944162ef8'
...
magick -size 1000x300 xc:none -fill white -stroke '#24104f' -strokewidth 5 \
    -gravity center -pointsize 86 -font DejaVu-Sans-Bold \
    -annotate +0+0 'POKÉMON VIOLET' "$artwork_dir/logo.png"

exec "$repo_dir/run-python-tool.sh" add-steam-shortcut.py \
    'Pokémon Violet' "$case_dir/launch-pokemon-violet.sh" --artwork-dir "$artwork_dir" "$@"
