...
[[ -e $previous_file ]] || steam_launch_options "$(steam_localconfig "$steam_root")" 48190 > "$previous_file"

"$case_dir/install-fixes.sh"
"$repo_root/set-steam-compat-tool.sh" 48190 'Proton Experimental'
"$repo_root/set-steam-launch-options.sh" 48190 'PROTON_PREFER_SDL=1 MANGOHUD_CONFIG=fps_limit=60,no_display mangohud %command%'
...
echo 'Restart Steam normally and launch App ID 48190.'
