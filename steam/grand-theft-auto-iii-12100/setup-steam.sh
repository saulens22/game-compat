...
"$case_dir/build-controller-skip.sh"
"$case_dir/../../set-steam-compat-tool.sh" 12100 'Proton-GE Latest'
printf -v intro_wrapper '%q' "$case_dir/launch-with-intros.sh"
"$case_dir/../../set-steam-launch-options.sh" 12100 "WINEDLLOVERRIDES=\"d3d8=n,b\" $intro_wrapper %command%"
