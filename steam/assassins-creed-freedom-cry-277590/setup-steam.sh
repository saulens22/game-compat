...
[[ -e $previous_file ]] || steam_launch_options "$(steam_localconfig "$steam_root")" 277590 > "$previous_file"

"$case_dir/install-fixes.sh"
"$repo_root/set-steam-compat-tool.sh" 277590 'Proton-GE Latest'
"$repo_root/set-steam-launch-options.sh" 277590 '%command%'
...
echo 'Restart Steam normally and launch App ID 277590.'
