...
[[ -e $previous_file ]] || steam_launch_options "$(steam_localconfig "$steam_root")" 15100 > "$previous_file"

"$case_dir/install-fixes.sh"
"$repo_root/set-steam-compat-tool.sh" 15100 'Proton-GE Latest'
"$repo_root/set-steam-launch-options.sh" 15100 \
...
echo 'Restart Steam normally and launch App ID 15100.'
